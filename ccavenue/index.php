      ...
      <div class="col-md-12">
		...
		<table width="40%" height="100" border='1' align="center">
			<table width="40%" height="100"  align="center" class="table" style="border:1px solid blue;">
				...
				<tr>
					<td>Merchant Id	:</td><td><input type="text" name="merchant_id" value="178695"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="http://test.smarttripmaker.com/ccdemo/ccavResponseHandler.php"/></td>
				</tr>
			 	<tr>
			 		<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="http://test.smarttripmaker.com/ccdemo/ccavResponseHandler.php"/></td>
			 	</tr>
			 	<tr>
