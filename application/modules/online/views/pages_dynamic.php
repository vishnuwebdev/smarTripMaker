...
<section class="inner-header pt-2 pb-2 pt-md-4 pb-md-4">
	<div class="container">
      ...
      <?php }else{ ?>
			<h1 class="text-center title-show-title"><?php echo $result->page_title; ?></h1>
			<h1 class="text-center title-back-title"><?php echo $result->page_title; ?></h1>
...
<main class="main-contant-wrap pt-md-3 pb-md-3"> 
	<div class="container">
		<div class="about-page-temp innerpage-com p-2 pt-md-3 pb-md-3 dyanmic-content-wrap">
			<div class="ctc-add-details pr-4 pl-4">
				<p><?php echo $result->page_desc; ?></p>
			</div>
		</div>
	</div>
