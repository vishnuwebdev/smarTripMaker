...
<table class="table table-hover table-bordered mb0" style="width:100%;border-collapse: collapse;    border-spacing: 0;border: 1px solid #000;">
	<thead>
		<tr>
		  <th class="firsttd" colspan="2" style="text-align:center;padding:15px 10px;border-bottom: 1px solid #000;">PACKAGE QUERY</th>
		</tr>
	</thead>
	  <tbody>
		<tr>
		...
		<tr>
		 ...
		 <tr>
		  <td class="firsttd" style="padding: 9px 8px;border-bottom: 1px solid #000;border-right: 1px solid #000;">Package Name</td>         
		  <td style="    padding: 9px 8px;    border-bottom: 1px solid #000;"><?php echo $result->holiday_name; ?></td>
		</tr>
