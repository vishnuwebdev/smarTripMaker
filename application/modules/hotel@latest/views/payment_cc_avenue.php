...
<?php 
  ...
  $merchant_data='';
  // $working_key='754F85D4B3E4DD8103B9A89871C7FC95';//Shared by CCAVENUES
  // $access_code='AVSM78FF38AC15MSCA';//Shared by CCAVENUES
...
?>
<!-- <form  id="payment_form" method="post" name="redirect" action="https://secure.ccavenue.com/transaction/transaction.do?command=initiateTransaction">  -->
