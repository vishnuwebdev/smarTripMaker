...
class Visa extends MX_Controller {
    ...
    public function index() {
		...
		$data["location_list"] 	= $this->VisaModel->location_list();
    ...
    public function sendNotifiction($visaId){
        ...
        $message .= "Country : ".$visaData->natiionlity."<br>";
        ...
        email_send ( "info@smarttripmaker.com", "Visa Request", $adminNotification );
