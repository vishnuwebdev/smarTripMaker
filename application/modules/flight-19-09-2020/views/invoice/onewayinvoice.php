							...
							<tbody>
							 ...
							 foreach ($SelectedFare->Response->Response->FlightItinerary->Passenger as $PaxDetails_lop){ ?>
								<tr>
									...
									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;">INR <?php echo $BookingDetails->fbook_customer_fare - ($PaxDetails_lop->Fare->BaseFare + round($PaxDetails_lop->Fare->YQTax - $baggage)); ?></td>

			
									
									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;">INR <?php echo isset($BookingDetails->fbook_baggage_amount) ? $BookingDetails->fbook_baggage_amount : '-'; ?></td>
