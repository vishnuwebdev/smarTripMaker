						...
						<table style="width: 800px;min-width: 100%; border-spacing: 0px;border-collapse: collapse;border:1px solid #000;">
							...
							<tbody>
							 <?php foreach ($SelectedFare->Response->Response->FlightItinerary->Passenger as $PaxDetails_lop){ ?>
								<tr>
									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;"> <?php echo $PaxDetails_lop->Title; ?> <?php echo $PaxDetails_lop->FirstName; ?> <?php echo $PaxDetails_lop->LastName; ?></td>
									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;"><?php echo $BookingDetails->fbook_arrive_airport_code; ?> -> <?php echo $BookingDetails->fbook_depart_airport_code; ?>
</td>
									...
									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;">INR <?php echo $PaxDetails_lop->Fare->BaseFare; ?></td>
									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;">INR <?php echo round($PaxDetails_lop->Fare->YQTax); ?></td>
									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;">INR <?php echo $BookingDetails->fbook_ib_customer_fare - ($PaxDetails_lop->Fare->BaseFare + round($PaxDetails_lop->Fare->YQTax)); ?></td>
									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;">INR <?php echo round($BookingDetails->fbook_ib_customer_fare);?></td>
								</tr>
					...
					<td colspan="2" style="padding-bottom: 15px;">
						<table style="width: 800px;min-width: 100%; border-spacing: 0px;border-collapse: collapse;border:1px solid #000;">
							<tr>
								...
								<td style="padding: 6px;">INR <?php echo (round($BookingDetails->fbook_customer_fare) + round($BookingDetails->fbook_ib_customer_fare)); ?></td>
							</tr>
						</table>
					</td>
				</tr>
