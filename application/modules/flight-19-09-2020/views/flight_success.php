		            ...
		            <div class="contant">
		            	<ul class="fare_details list-unstyled mb-0">
		            		...
		            		<li>Tax (+)<span class="float-right"><i class="icofont-rupee"></i>
		            		 ...
		            		 <?php echo round($BookingDetails->fbook_customer_fare + $BookingDetails->fbook_transaction_fee - $SelectedFare->Response->Response->FlightItinerary->Fare->BaseFare - $baggage); ?></span></li>

		            		<li>Baggage <?php echo isset($BookingDetails->fbook_baggage_weight) ? $BookingDetails->fbook_baggage_weight.' KG'  : '-'; ?>  <span class="float-right"><i class="icofont-rupee"></i> <?php echo isset($BookingDetails->fbook_baggage_amount) ? $BookingDetails->fbook_baggage_amount : '-'; ?></span></li>
