				                        ...
				                        <div class="col-md-2 col-sm-2 p-0">
				                          <div class="flht-ex text-center">
				                            <h3 class="airline_price mb-0">
				                              <i class="icofont-rupee"></i><span> <?php echo round($customer_fare/$total_pax); ?></span>
				                            </h3>
									...
									<div class="table-responsive">
										<table class="table table-bordered table-striped">
											...
											<tbody>
												<tr>
													<td>Base Fare</td>
													<td><i class="icofont-rupee"></i> <?php echo number_format($baseFare); ?></td>
												</tr>
												<tr>
													<td>Airline Fuel Surcharges</td>
													<td><i class="icofont-rupee"></i> <?php echo number_format($taxvalue) ; ?></td>
												</tr>
												<tr>
													<th>Total</th>
													<th><i class="icofont-rupee"></i> <?php echo number_format($offerfareround); ?></th>
												</tr>
											</tbody>
											<tfoot>
												<tr>
									...
									<div class="table-responsive">
										<table class="table table-bordered table-striped">
											...
											<tbody>
												<tr>
													<td>Base Fare</td>
													<td><i class="icofont-rupee"></i> <?php echo number_format($baseFarereturn); ?></td>
												</tr>
												<tr>
													<td>Airline Fuel Surcharges</td>
													<td><i class="icofont-rupee"></i> <?php echo number_format($taxvaluereturn) ; ?></td>
												</tr>
												<tr>
													<th>Total</th>
													<th><i class="icofont-rupee"></i> <?php echo number_format($offerfareroundreturn); ?></th>
												</tr>
											</tbody>
											<tfoot>
												<tr>
...
<div id="foo-fixed-price-dom" class="footer-fixed-prc">
	<div class="container-fluid">
	    <div class="row">
	      <div class="col-lg-5 col-md-5 border-right_l" id="bookingstripviewOB">

	      </div>
	      <div class="col-lg-5 col-md-5 border-right_l" id="bookingstripviewIB">
	      ...
	      <div class="col-md-2 col-sm-12 col-12">
	        <ul class="list-inline foo-fxd-book mb-0">
	          ...
	          <li class="airline_price d-md-block" ><i class="icofont-rupee"></i><span id="price_anim"><?php echo round(($offerfareseelctedOB+$offerfareseelctedIB)/$total_pax); ?> </span></li>
			  
	          <li class="bookbtn">
			  <button type="button" class="btn costom_site_color btn-com" id="returnBookingbtn" 
				...
				searchid="<?php echo $searchID; ?>"> Book </button>
...
//======Reset All====		
  ...
  $( function() {
    ...
    $( "#amount-sec" ).val( "Rs." + $( "#slider-range" ).slider( "values", 1 ) );
  } );
 ...
 $( function() {
    ...
    $( "#slider-range_ret" ).slider({
      ...
      max: <?php echo $pricefiltermax ; ?>,
       values: [ <?php echo $pricefiltermin ; ?>, <?php echo $pricefiltermax ; ?> ],
      slide: function( event, ui ) {        
       $( "#amount_ret" ).val( "Rs." + ui.values[ 0 ]  );
       $( "#amount-sec_ret" ).val( "Rs." + ui.values[ 1 ] );
    ...
    $( "#amount_ret" ).val( "Rs." + $( "#slider-range_ret" ).slider( "values", 0 ));
    $( "#amount-sec_ret" ).val( "Rs." + $( "#slider-range_ret" ).slider( "values", 1 ) );
  } );	
