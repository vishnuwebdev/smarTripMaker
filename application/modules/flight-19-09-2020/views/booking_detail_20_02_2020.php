				...
				<div class="flt-booking-wrap mb-2 mb-md-3">
						...
						<div class="flt-booking-dts">
							<div class="row">
								<div class="col-md-6">
									 <div class="form-group">
									 	<?php //echo "<pre>"; print_r($baggage->Response->Baggage[0]); ?>
									 	<?php 
									 	//echo "<pre>";
									 	//print_r($baggage->Response); ?>
...
<div class="multiple_select_checkbox">
   ...
   <div class="multiple_select_checkbox_choice"><input type="checkbox" name="meal"  value="<?php echo base64_encode(($baggage->Response->MealDynamic[0][$i]->AirlineDescription."#".$baggage->Response->MealDynamic[0][$i]->Price)); ?>" /><?php echo ($baggage->Response->MealDynamic[0][$i]->AirlineDescription); ?></div>
...
$(".bookingbtnpopup").on('click',function(){

})
//mealcheckbox

$(':checkbox[name=meal]').on('click', function() {
    var assignedTo = $(':checkbox[name=meal]:checked').map(function() {
	...
	$(".finalamount").html(<?php echo round($customer_fare + $final_con); ?>+parseInt(localStorage.getItem("baggageitem"))+parseInt(localStorage.getItem("totalMeal")));
