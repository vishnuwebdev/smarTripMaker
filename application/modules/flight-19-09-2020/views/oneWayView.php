								...
								?>
									...
									<div class="col-md-2 col-sm-4 col-6">
										<div class="price-flt fl-o-way-com txt-lt">
											<h6><i class="icofont-rupee"></i> <?php echo round($customer_fare/$total_pax); ?></h6>
										</div>
									</div>
									<div class="col-md-2 col-sm-4 col-6">
												  		...
												  		<div class="table-responsive">
												  			<table class="table table-bordered table-striped">
												  				...
												  				<tbody>
												  					<tr>
												  						<td>Base Fare</td>
												  						<td><i class="icofont-rupee"></i> <?php echo round($baseFare); ?></td>
												  					</tr>
												  					<tr>
												  						<td>Airline Fuel Surcharges</td>
												  						<td><i class="icofont-rupee"></i> 
																		<?php echo round($customer_fare - $baseFare );?>
																		</td>
												  					</tr>
												  					<tr>
												  						<th>Total</th>
												  						<th><i class="icofont-rupee"></i> <?php echo round($customer_fare); ?></th>
												  					</tr>
												  				</tbody>
												  				<tfoot>
												  					<tr>
