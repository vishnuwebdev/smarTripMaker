    ...
    <div class="paul-card-content">
      <div class="paul-layout">      
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <input type="date" name="dob" required="required" id="dateofBirth" class="form-control" placeholder="Name">
          </div>
        </div>
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          <input required="required" type="date" name="departureDate" id="departure-date" class="form-control" placeholder="Departure Date" value=""  >
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          <input type="date" name="arrivalDate" required="required" id="arrivalDate" class="form-control" placeholder="Arrival Date" value=""  >
        </div>
      </div>

      <div class="col-md-12">
        <div class="form-group">
          <input type="hidden" name="visa_id" value="<?php echo isset($visa_id) ? $visa_id : ''; ?>"  >
