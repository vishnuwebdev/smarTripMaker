                                ...
                                <tr>
                                    <td align="center">
                                        <table width="800" style="margin:0 0">
                                            <tbody>
                                                <tr>
                                                    <td align="left" style="padding: 12px 0 8px 0;"><a href="<?php echo $this->dsa_data->dsa_admin_url;?>assets/img/logos/<?php echo $this->dsa_data->dsa_logo;?>" target="_blank" style="color:#d8d8d8; text-decoration:none;outline:0;"><img width="20%" src="<?php echo $this->dsa_data->dsa_admin_url;?>assets/img/logos/<?php echo $this->dsa_data->dsa_logo;?>" border="0"></a>
                                                    </td>
                                                        ...
                                                        <table style="width:100%; border-collapse:collapse">
                                                            <tbody>
                                                                <tr>
                                                                    <td style="vertical-align:top; padding:18px 18px 8px 23px; ">
                                                                        <p style="font-size:16px; color:#333333; text-transform:uppercase; font-weight:900; margin:0; ">
                                                                           Your Booking Id: <?php echo $booking_details->hoffbo_id;?>
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td align="left" style="padding:10px 0 10px 0px;text-align:center; " width="117"><p style="font-size:14px; text-transform:uppercase; color:#333333; margin:0; font-weight:normal;  ">
														<p><?php echo $hotel_details->hofl_address;?>, <?php echo $hotel_details->hofl_city;?>, <?php echo $hotel_details->hofl_state;?>, <?php echo $hotel_details->hofl_country;?>, <?php echo $hotel_details->hofl_pincode;?></p>
												   </td>

                                                </tr>
												<tr>
                                                    <td align="left" style="padding:10px 0 10px 0px;text-align:center; " width="117"><p style="font-size:14px; text-transform:uppercase; color:#333333; margin:0; font-weight:normal;  ">
													    <p><b>Hotel Contact Number : </b> <?php if($hotel_details->hofl_phone){echo "<i class='fa fa-phone'></i>".$hotel_details->hofl_phone;} else{ echo "Contact details are not available"; } ?></p>
													</td>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
													...
													<td align="left" style="padding:10px 0 10px 0px;text-align:center; " width="117">
                                                        ...
                                                        <p style="font-size:14px; text-transform:uppercase; color:#333333; margin:0; font-weight:normal;  ">
                                                           <b> 
															<?php echo $booking_details->hoffbo_max_adult;?>Adults, <?php echo $booking_details->hoffbo_max_child;?> Children
														   </b>
														</p>
													</td>
												</tr>
                                                ...
                                                <tr>
                                                    <td align="left" style="padding:10px 0 10px 0px;text-align:center; " width="117">
                                                        ...
                                                        <p style="font-size:14px; text-transform:uppercase; color:#333333; margin:0; font-weight:normal;  ">
														   ...
														   <b> 
															 <?php echo $bp_pax_reqdetails->hotbopax_title;?> <?php echo $bp_pax_reqdetails->hotbopax_first_name;?> <?php echo $bp_pax_reqdetails->hotbopax_last_name;?> 
														   </b><br>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td align="left" style="padding:10px 4px 10px 10px;;text-align:left; " width="117"><p style="font-size:14px; text-transform:uppercase; color:#333333; margin:0; font-weight:normal;  ">
                                                            Room Price:</p></td>
                                                    <td align="left" style="padding:10px 0 10px 0px;text-align:center; " width="117"><p style="font-size:14px; text-transform:uppercase; color:#333333; margin:0; font-weight:normal;  ">
                                                    <i class=""></i><?php echo $this->bp_white_label_setting->wls_currency_symbol;?>  <?php echo dsa_currency_convert($booking_details->hoffbo_basic_fare);?> </p></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" style="padding:10px 0 10px 0px;text-align:center; " width="117"><p style="font-size:14px; text-transform:uppercase; color:#333333; margin:0; font-weight:normal;  ">
                                                    <i class=""></i><?php echo $this->bp_white_label_setting->wls_currency_symbol;?> <?php echo dsa_currency_convert($booking_details->hoffbo_tax);?> </p></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <i class=""></i><?php echo $this->bp_white_label_setting->wls_currency_symbol;?> <?php echo dsa_currency_convert($booking_details->hoffbo_publish_fare);?> </p></td>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td align="right" style="vertical-align:middle; padding:22px 50px 22px 0; ">
                                                        <p style="color:#FFF; font-size:18px; margin:0; ">
                                                            <a href="<?php echo $this->dsa_data->dsa_b2c_url; ?>" target="_blank" style="text-decoration:none; color:#fff; font-weight:bold;outline:0;"><?php echo $this->dsa_data->dsa_b2c_url; ?></a>
                                                        </p>
                                                    </td>
                                                </tr>
                                            </tbody>
