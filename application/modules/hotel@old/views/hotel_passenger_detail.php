		...
		<div class="row">
			...
			<?php if($this->session->userdata("Userlogin") != NULL){              
				$bp_customer_total_balance=$this->user_data->cust_balance;
				 $bp_total_fare = $bp_customer_price;	
				...
				<input name="payment_method" class="payment_option" checked type="radio" value="<?php echo $getwayLists->dsapayg_gateway_name; ?>"> <?php echo $getwayLists->dsapayg_gateway_name; ?>
					...
					<?php $_SESSION['hotel']['Conv_fee'] = $final_con;?>
					<br/><br/>
					</div>
					</div>
					<?php //} ?> 
				...
				<div class="flght-side-det">
		            ...
		            <div class="contant">
		            	<ul class="fare_details list-unstyled mb-0">
		            		<li>Base Fare <span class="float-right"><i class="icofont-rupee"></i> <?php echo round($bp_base_price); ?></span></li>
		            		<li>Tax (+)<span class="float-right"><i class="icofont-rupee"></i> <?php echo round($bp_tax); ?></span></li>
							<?php if($getwayList!="0"){
							// $getwayLists = $getwayList[0];					
							 // if($getwayLists->dsapayg_type = "fix"){
								  // $final_con =  $getwayList[0]->dsapayg_convenience_fee;
						...
						<li>Convenience Fee<span class="float-right"><i class="icofont-rupee"></i><?php echo $final_con; ?></span></li>
						
                        <?php }else { $final_con = 0; }  ?>
		            		
		            		<li>Total Fare<span class="float-right"><i class="icofont-rupee"></i> <?php echo round($bp_customer_price+$final_con); ?></span></li>
		            	</ul>
		            </div>
		        </div>
			</div>
             ...
             <div class="col-md-4">
                 <div class="row airlines">
                    <ul class="fare_details">
                        <li>Base Fare <span class="pull-right"><i class="icofont-rupee"></i> <?php echo 0; ?></span></li>
                        <li>Tax <span class="pull-right"><i class="icofont-rupee"></i> <?php echo 0; ?></span></li>
                        <li>Total Fare <span class="pull-right"><i class="icofont-rupee"></i> <?php echo 0; ?></span></li>
                    </ul>
                </div>
             </div>
              </div>
