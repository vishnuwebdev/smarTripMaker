				...
				<div class="col-md-3" id="sidebar-flght">  
					<div class="search-by-filter">
						...
						<div class="sidebar-com price-airlines price-range pb-2 pb-md-3 border-bottom mb-md-3 ">
					 		<h6 class="font-weight-normal mb-2">Price Range <button type="button" class="btn btn-success btn-xs" hotel-price-slider-apply-btn="true" >Apply</button></h6>
...
// Filter By Price---------
  ...
  $(function() {
    ...
    $( "#amount" ).val( "Rs. " + "<?php echo min($_SESSION ['hotel'] ['price']); ?>" );
	  $( "#amount1" ).val("Rs. " + "<?php echo max($_SESSION ['hotel'] ['price']); ?>" );  
