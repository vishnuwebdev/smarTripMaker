				...
				<div class="flght-side-det">
		            ...
		            <div class="contant">
		            	<ul class="fare_details list-unstyled mb-0">
		            		<li>Base Fare <span class="float-right"><i class="icofont-rupee"></i> <?php echo round($bp_hotel_one_room_detail->Price->RoomPrice);?></span></li>
		            		<li>Tax (+)<span class="float-right"><i class="icofont-rupee"></i> <?php echo round($bp_customer_price + $bp_hotel_detailq->hotboli_transaction_fee  -$bp_hotel_one_room_detail->Price->RoomPrice);?></span></li>
		            		<li>Total Fare<span class="float-right"><i class="icofont-rupee"></i><?php echo round($bp_customer_price + $bp_hotel_detailq->hotboli_transaction_fee) ;?></span></li>
		            	</ul>
		            </div>
		        </div>
