                ...
                <tr>
                    <td align="center">
                        <table class="main_tbl3">
                            <tbody>
<tr>
    <td class="logo_td" align="left"><a href="https://www.tripsarathi.com" target="_blank"><img src="<?php echo site_url(); ?>admin/assets/img/logos/logo_(8).png" border="0"></a>
    </td>
                                   ...
                                   ?>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left"><p>
                                            Fare:</p></td>
                                        <td align="left"><p>
                                           <?php echo $this->dsa_data->dsa_currency.' '.$total ?></p></td>
                                    ...
                                    <tr>
                                        <td align="left"><p>
                                            Fee & Surcharge:</p></td>
                                        <td align="left"><p>
                                         <?php echo $this->dsa_data->dsa_currency ?>   0</p></td>
