                                    ...
                                    <div class="clearfix">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="clearfix mt15">
                                                    <label for="">First Name</label>
                                                    <input type="text" name="infant[<?php echo $i; ?>][first_name_infant_<?php echo $i; ?>]" class="input block width-100 border" placeholder="Enter your name" required="">
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="clearfix mt15">
                                                    <label for="">Last Name</label>
                                                    <input type="text" name="infant[<?php echo $i; ?>][last_name_infant_<?php echo $i; ?>]" class="input block width-100 border" placeholder="Enter your name" required="">
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="clearfix mt15">
                                                    <label for="">Passport number</label>
                                                    <input type="text" name="infant[<?php echo $i; ?>][passport_no_infant_<?php echo $i; ?>]" class="input block width-100 border" placeholder="Passport number" required="">
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="clearfix mt15">
                                                    <label for="">Date of birth</label>
                                                    <input type="text" name="infant[<?php echo $i; ?>][date_of_birth_infant_<?php echo $i; ?>]" class="input block width-100 border datepicker" placeholder="Date of birth" readonly required="">
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="clearfix mt15">
                                                    <label for="">Passport expiry date</label>
                                                    <input type="text" name="infant[<?php echo $i; ?>][pass_expire_date_infant_<?php echo $i; ?>]" class="input block width-100 border datepicker" placeholder="Passport expiry date" readonly required="">
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="clearfix mt15">
                                                    <label for="">Passport issue date</label>
                                                    <input type="text" name="infant[<?php echo $i; ?>][pass_issue_date_infant_<?php echo $i; ?>]" class="input block width-100 border datepicker" placeholder="Passport issue date" readonly required="">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="clearfix mt15">
                                                    <label for="">Passport nationality</label>
                                                    <select class="select block width-100 border" name="infant[<?php echo $i; ?>][pass_issue_country_infant_<?php echo $i; ?>]" required="">
                                                        <option value="">Select</option>
                                                      <?php foreach ($allcountry as $allcountries) { ?>
                                                            <option value="<?php echo $allcountries->country_code . '_' . $allcountries->country_name; ?>"><?php echo $allcountries->country_name; ?></option>
                                    <?php } ?>
...
?>
                            ...
                            <div class="clearfix mb15 agreetotheterms">
                                <input type="checkbox" name="" id="agreetotheterms_pax" required=""> <label for="agreetotheterms_pax" class="inline-block pointer fz12 black-color vat">By proceeding, you agree with our <a href="#none">Terms of Service</a> &amp; <a href="#none">Privacy Policy</a></label>
                            </div>
                        </div>
...
<?php } ?>
                    ...
                    <div class="clearfix p15">
                        <ul class="pack-ul-details clearfix">
                            <li class="clearfix">
                                <span class="left">Days : <?php echo $bookingdetail->holiday_night + 1; ?> </span>
                                <strong class="right">Nights : <?php echo $bookingdetail->holiday_night; ?></strong>
                            </li>
                            <li class="clearfix">
                            ...
                            <li class="clearfix">
                                <span class="left">Adults :   <?php echo $paxnoadult = $this->input->get("adult_no"); ?></span>
                                <strong class="right"><?php echo $this->dsa_data->dsa_currency; ?> <?php echo $adulttotal = $bookingdetail->holiday_start_price * $paxnoadult; ?></strong>
                            </li>
                            <?php
                            $childtotal = 0;
                            if ($this->input->get("child_no") != NULL) {
                                ?>
                                <li class="clearfix">
                                    <span class="left">Childs :   <?php echo $paxnochild = $this->input->get("child_no"); ?></span>
                                    <strong class="right"><?php echo $this->dsa_data->dsa_currency; ?> <?php echo $childtotal = $bookingdetail->holiday_start_price * $paxnochild; ?></strong>
                                </li>
<?php } ?>
<?php
$infanttotal = 0;
if ($this->input->get("infant_no") != NULL) {
    ?>
                                <li class="clearfix">
                                    <span class="left">Infants :   <?php echo $paxnoinfant = $this->input->get("infant_no"); ?></span>
                                    <strong class="right"><?php echo $this->dsa_data->dsa_currency; ?> <?php echo $infanttotal = $bookingdetail->holiday_start_price * $paxnoinfant; ?></strong>
                                </li>
<?php } ?>
                            <li class="clearfix">
                                <span class="left">Subtotal</span>
                                <strong class="right"><?php echo $this->dsa_data->dsa_currency; ?> <?php echo $finalsubtotal = $adulttotal + $childtotal + $infanttotal; ?></strong>
                            </li>
                            <li class="clearfix">
                                <span class="left">Tax & VAT</span>
                                <strong class="right"><?php echo $this->dsa_data->dsa_currency; ?> <?php
$taxandVat = 0;
...
?></strong>
                            ...
                            <li class="clearfix totalpriceofpack">
                                ...
                                <strong class="right"><?php echo $this->dsa_data->dsa_currency; ?> <?php echo $finalsubtotal + $taxandVatfinal; ?></strong>
                            </li>
                        </ul>
                    </div>
