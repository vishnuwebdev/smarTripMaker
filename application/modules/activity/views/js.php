<script src="<?php echo site_url(); ?>assets/plugin/jqueryUI/jquery-ui.js"></script>
...
<script src="<?php echo site_url();?>assets/plugin/jquery_validation/dist/jquery.validate.js"></script>
<script>
$("#searchform").validate({
	  rules: {
		  from_location:{
