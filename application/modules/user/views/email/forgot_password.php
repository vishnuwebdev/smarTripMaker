...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color:
 #f57153; font-weight: normal; text-decoration: none" target="_blank" title="">
                                      <img align="center" alt="Forgot your password?" class="mcnImage" src="<?php echo site_url(); ?>assets/holiday/images/reset.png" style="-ms-interpolation-mode: bicubic; border: 0; height: auto; outline: none;
 ...
 padding-right:48px; padding-bottom:24px; padding-left:48px;" valign="middle">
                                          <a class="mcnButton " href="<?php echo site_url(); ?>user/reset_passsword/<?php echo $forgotlink; ?>" style="mso-line-height-rule: exactly;
