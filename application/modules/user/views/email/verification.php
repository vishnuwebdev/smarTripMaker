...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color:
 #f57153; font-weight: normal; text-decoration: none" target="_blank" title="">
                                      <img align="center" alt="Forgot your password?" class="mcnImage" src="<?php echo site_url(); ?>assets/images/reset.png" style="-ms-interpolation-mode: bicubic; border: 0; height: auto; outline: none;
 ...
 color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">Please press button to acitvate your Account !
                                <br></br>
                              </td>
                            </tr>
                          </tbody>
 ...
 padding-right:48px; padding-bottom:24px; padding-left:48px;" valign="middle">
                                          <a class="mcnButton " href="<?php echo site_url(); ?>user/verify_email/<?php echo $verificationlink; ?>" style="mso-line-height-rule: exactly;
 ...
 font-weight: normal; text-decoration: none; color:#7F6925;" target="_blank" title="Noun Project - Icons for Everything">VistorMantra</a> All Rights Reserved</div>
                              </td>
                            </tr>
                            <tbody></tbody>
                          </tbody>
