...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 font-weight: normal; text-decoration: none" target="_blank" title="">
                                  <img align="none" alt="" height="40" src="<?php echo site_url(); ?>admin/assets/img/logos/logo_(8).png" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
 ...
 padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top">
                                <a class="" href="<?php echo site_url(); ?>" style="mso-line-height-rule:
 ...
 exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color:
 #f57153; font-weight: normal; text-decoration: none" target="_blank" title="">
                                      <img align="center" alt="Forgot your password?" class="mcnImage" src="http://www.clker.com/cliparts/J/C/X/z/E/s/shopping-cart-md.png" style="-ms-interpolation-mode: bicubic; border: 0; height: 150px; outline: none;
 text-decoration: none; vertical-align: bottom; width:150px; padding-bottom:
 ...
 padding: 0'><span style="text-transform:uppercase">Payment</span></h1>
 ...
 padding: 0'><span style="text-transform:uppercase">pending</span></h2>
 ...
 color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">Please press button to Login to your Dashbaord !
                                <br></br>
                              </td>
                            </tr>
                          </tbody>
 ...
 padding-right:48px; padding-bottom:24px; padding-left:48px;" valign="middle">
                                          <a class="mcnButton " href="<?php echo site_url(); ?>user/dashboard" style="mso-line-height-rule: exactly;
 ...
 none" target="_blank">
                                    ...
                                    <img align="none" alt="Heart icon" height="10" src="<?php echo site_url(); ?>assets/holiday/images/made-with-heart.png" style="-ms-interpolation-mode: bicubic; border: 0; height: auto; outline: none;
 ...
 font-weight: normal; text-decoration: none; color:#7F6925;" target="_blank" title="Noun Project - Icons for Everything">Booking Tours</a> All Rights Reserved</div>
                              </td>
                            </tr>
                            <tbody></tbody>
                          </tbody>
