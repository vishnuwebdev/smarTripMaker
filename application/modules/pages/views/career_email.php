...
<table class="table table-hover table-bordered mb0" style="width:100%;border-collapse: collapse;    border-spacing: 0;border: 1px solid #000;">
	<thead>
		<tr>
		  <th class="firsttd" colspan="2" style="text-align:center;padding:15px 10px;border-bottom: 1px solid #000;">JOB QUERY</th>
		</tr>
	</thead>
	  <tbody>
		<tr>
		  ...
		  <?php echo $result->job_name; ?></td>
		</tr>
		<tr>
		  <td class="firsttd" style="padding: 9px 8px; border-bottom: 1px solid #000; border-right: 1px solid #000;">Email Id</td>
		  <td style="padding: 9px 8px; border-bottom: 1px solid #000;"><?php echo $result->job_email; ?></td>
		</tr>
		
		<tr>
		  <td class="firsttd" style="padding: 9px 8px;border-bottom: 1px solid #000; border-right: 1px solid #000;">Phone Number</td>         
		  <td style="padding: 9px 8px; border-bottom: 1px solid #000;"><?php echo $result->job_mobile; ?></td>
		</tr>
		
		 <tr>
		  <td class="firsttd" style="padding: 9px 8px;border-bottom: 1px solid #000;border-right: 1px solid #000;">Subject</td>         
		  <td style="    padding: 9px 8px;    border-bottom: 1px solid #000;"><?php echo $result->job_subject; ?></td>
		</tr>
		<tr>
		  <td class="firsttd" style="padding: 9px 8px; border-bottom: 1px solid #000; border-right: 1px solid #000;">Message</td>         
		  <td style="padding: 9px 8px;border-bottom: 1px solid #000;"><?php echo $result->job_description; ?></td>
		</tr>
		<tr>
		  <td class="firsttd" style="padding: 9px 8px; border-bottom: 1px solid #000; border-right: 1px solid #000;">Resume</td>         
		  <td style="padding: 9px 8px;border-bottom: 1px solid #000;"><a href="http://localhost/smarttripmaker/assets/resume/<?php echo $result->job_resume ?>">  <?php echo $result->job_resume; ?> </a></td>
		</tr>
