			...
			<tbody>
								...
								<td style="border-top: 1px solid #000;border-bottom: 1px solid #000;border-right: 1px solid #000; padding: 8px;">
									<table style="width: 100%; border-spacing: 0px;border-collapse: collapse;">
										<tbody>
											...
											<tr><td>IN Bound PNR:</td><td><strong><?php echo $BookingDetails->fbook_ib_pnr; ?></strong></td></tr>
							 ...
							 <?php foreach ($PaxDetails as $PaxDetails_lop){ ?>
								<tr>
									...
									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;">
										<?php echo isset($BookingDetails->fbook_ob_baggage_weight) ? $BookingDetails->fbook_ob_baggage_weight."KG " : ''; ?> 
									</td>

									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;">
										<?php echo isset($BookingDetails->fbook_ob_meals_amount) ? $BookingDetails->fbook_ob_meals_amount : ''; ?>  
									</td>
							...
							<tbody>
							 <?php foreach ($PaxDetails as $PaxDetails_lop){ ?>
								<tr>
									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;"> <?php echo $PaxDetails_lop->fpax_title; ?> <?php echo $PaxDetails_lop->fpax_first_name; ?> <?php echo $PaxDetails_lop->fpax_last_name; ?></td>
									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;">
										<?php echo isset($BookingDetails->fbook_ib_baggage_weight) ? $BookingDetails->fbook_ib_baggage_weight."KG " : ''; ?> 
									</td>

									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;">
										<?php echo isset($BookingDetails->fbook_ib_meals_amount) ? $BookingDetails->fbook_ib_meals_amount : ''; ?>  
									</td>
									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;"> <?php echo $BookingDetails->fbook_ib_pnr; ?></td>
									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;"> <?php echo $BookingDetails->fbook_ib_booking_id; ?></td>
								</tr>
							 <?php }?>
							</tbody>
				...
				<tr>
					<td colspan="2" style="padding-bottom: 15px;">
						<table style="width: 800px;min-width: 100%; border-spacing: 0px;border-collapse: collapse; border:1px solid #000;">
							...
							<tbody>
							<?php 
							foreach ($SelectedFare->Response->Response->FlightItinerary->Segments as $seg => $segmentloop){	if($segmentloop->TripIndicator == 1){
									?>
								<tr>
				...
				<tr>
					<td colspan="2" style="padding-bottom: 15px;">
						...
						<tbody>
						<?php 
							foreach ($SelectedFareIB->Response->Response->FlightItinerary->Segments as $seg => $segmentloop){	if($segmentloop->TripIndicator == 1){
						?>
								<tr>
									<td style="padding: 7px 12px;border-right: 1px solid #000;">
										<img src="<?php echo site_url(); ?>assets/images/airlines/<?php echo $segmentloop->Airline->AirlineCode; ?>.gif">
				...
				<tr>
					<td colspan="2" style="padding-bottom: 20px">
						<table style="width: 800px;min-width: 100%;border-spacing: 0px;border-collapse: collapse;border:1px solid #000;">
							<tbody>
								<tr colspan="2">
									<td colspan="2" style="font-weight:bold;font-size:15px;text-align:center;padding: 7px 12px;background-color: #d8d8d8;border: 1px solid #000;">PAYMENT DETAILS(OUTBOUND)</td>
								</tr>
								<tr>
										...
										<table style="width: 100%; border-spacing: 0px;border-collapse: collapse;">
											<tbody>
												...
												<tr>
													...
													<td style="padding: 7px 12px;    border-bottom: 1px solid #000;"><?php echo $BookingDetails->fbook_customer_fare - $SelectedFare->Response->Response->FlightItinerary->Fare->BaseFare; ?> </td>
												</tr>
												<tr>
													<td style="padding: 7px 12px;border-right: 1px solid #000;">TOTAL AIR FARE:</td>
													<td style="padding: 7px 12px;"><?php echo $BookingDetails->fbook_customer_fare; ?> </td>
												</tr>
											</tbody>
										</table>
									</td>
				...
				<tr>
					<td colspan="2" style="padding-bottom: 20px">
						<table style="width: 800px;min-width: 100%;border-spacing: 0px;border-collapse: collapse;border:1px solid #000;">
							<tbody>
								<tr colspan="2">
									<td colspan="2" style="font-weight:bold;font-size:15px;text-align:center;padding: 7px 12px;background-color: #d8d8d8;border: 1px solid #000;">PAYMENT DETAILS(INBOUND)</td>
								</tr>
								<tr>
									<td style="padding: 7px 12px;border: 1px solid #000;"> THIS IS AN ELECTRONIC TICKET. PLEASE CARRY A POSITIVE IDENTIFICATION FOR CHECK IN.</td>
									<td style="border: 1px solid #000;">
										<table style="width: 100%; border-spacing: 0px;border-collapse: collapse;">
											<tbody>
												<tr>
													<td style="padding: 7px 12px;border-right: 1px solid #000;    border-bottom: 1px solid #000;">AIR FARE:</td>
													<td style="padding: 7px 12px;    border-bottom: 1px solid #000;"><?php echo $SelectedFareIB->Response->Response->FlightItinerary->Fare->BaseFare; ?></td>
												</tr>
												<tr>
													<td style="padding: 7px 12px;border-right: 1px solid #000;    border-bottom: 1px solid #000;">TAX AND ADDITIONAL CHARGE (+):</td>
													<td style="padding: 7px 12px;    border-bottom: 1px solid #000;"><?php echo $BookingDetails->fbook_ib_customer_fare + $BookingDetails->fbook_transaction_fee - $SelectedFareIB->Response->Response->FlightItinerary->Fare->BaseFare; ?> </td>
												</tr>
												<tr>
													<td style="padding: 7px 12px;border-right: 1px solid #000;">TOTAL AIR FARE:</td>
													<td style="padding: 7px 12px;"><?php echo $BookingDetails->fbook_ib_customer_fare + $BookingDetails->fbook_transaction_fee; ?> </td>
												</tr>
											</tbody>
										</table>
									</td>
				...
				<tr>
					<td colspan="2">
						<table style="width: 800px;min-width: 100%;border-spacing: 0px;border-collapse: collapse;border:1px solid #000;">
							<tbody>
								<tr colspan="2">
									<td colspan="2" style="font-weight:bold;font-size:15px;text-align:center;padding: 7px 12px;background-color: #d8d8d8;border: 1px solid #000;"> TOTAL PAYMENT DETAILS(OUTBOUND + INBOUND)</td>
								</tr>
								<tr>
									<td style="padding: 7px 12px;border: 1px solid #000;"> THIS IS AN ELECTRONIC TICKET. PLEASE CARRY A POSITIVE IDENTIFICATION FOR CHECK IN.</td>
									<td style="border: 1px solid #000;">
										<table style="width: 100%; border-spacing: 0px;border-collapse: collapse;">
											<tbody>
												<tr>
													<td style="padding: 7px 12px;border-right: 1px solid #000;    border-bottom: 1px solid #000;">OUTBOUND TOTAL FARE (+):</td>
													<td style="padding: 7px 12px;border-bottom: 1px solid #000;"> <?php echo $BookingDetails->fbook_customer_fare; ?> </td>
												</tr>
												<tr>
													<td style="padding: 7px 12px;border-right: 1px solid #000;    border-bottom: 1px solid #000;"> INBOUND TOTAL FARE (+):</td>
													<td style="padding: 7px 12px;    border-bottom: 1px solid #000;"><?php echo $BookingDetails->fbook_ib_customer_fare + $BookingDetails->fbook_transaction_fee; ?>  </td>
												</tr>
												<tr>
													<td style="padding: 7px 12px;border-right: 1px solid #000;">TOTAL FARE:</td>
													<td style="padding: 7px 12px;"> <?php echo $BookingDetails->fbook_ib_customer_fare + $BookingDetails->fbook_customer_fare+ $BookingDetails->fbook_transaction_fee; ?> </td>
												</tr>
											</tbody>
										</table>
									</td>
