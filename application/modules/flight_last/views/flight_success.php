						...
						<div class="trv-topbar mb-3">
							...
							<div class="row flt-booking-dts">
								...
								<div class="col-md-2 col-sm-2 col-6">
									<div class="dep-dr fl-o-way-com txt-right">
										<i class="icofont-school-bag font-22"></i> <strong><?php echo ($PaxDetails23->fpax_baggage_weight) ? $PaxDetails23->fpax_baggage_weight. 'KG' : ''; ?> </strong>
									</div>
								</div>
								
								<div class="col-md-4 col-sm-4 col-6">
									<div class="arv-dr fl-o-way-com txt-lt">
										<i class="icofont-fast-food font-22"></i> <?php print_r($PaxDetails23->fpax_meal_item); ?>
