							...
							<tbody>
							 <?php 
								...
								<tr>
									...
									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;"><?php echo isset($PaxDetails_lop->fpax_baggage_weight) ? $PaxDetails_lop->fpax_baggage_weight : ''; ?> KG </td>

									<td style="border-left:1px solid #000; padding: 7px 12px;border-right: 1px solid #000;">
										<?php echo isset($PaxDetails_lop->fpax_meal_item) ? $PaxDetails_lop->fpax_meal_item : ''; ?>  </td>
