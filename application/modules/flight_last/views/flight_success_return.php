				...
				<div class="flght-side-det">
		            ...
		            <div class="contant">
						...
						<li><strong>Onward</strong></li>
		            		...
		            		<li>Tax (+)<span class="float-right"><i class="icofont-rupee"></i>  <?php echo $BookingDetails->fbook_customer_fare  - $SelectedFare->Response->Response->FlightItinerary->Fare->BaseFare; ?></span></li>
					...
					<div class="contant">
						...
						<li><strong>Return</strong></li>
		            		...
		            		<li>Tax (+)<span class="float-right"><i class="icofont-rupee"></i> <?php echo $BookingDetails->fbook_ib_total_fare + $BookingDetails->fbook_transaction_fee - $SelectedFareIB->Response->Response->FlightItinerary->Fare->BaseFare; ?></span></li>
