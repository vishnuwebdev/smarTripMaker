...
if (isset ( $result )) {																																			if (is_array ( $result )) {																															$i = 1;																																			foreach ( $result as $bp ) {																															?>
                                    <tr>
									<td><?php echo $i; ?></td>
                                    <td> <?php echo $bp->com_name; ?></td>
									<td><?php echo $bp->com_email; ?></td>
									<td><?php echo $bp->com_mobile; ?></td>
                                                                        <td><?php echo $bp->com_description; ?></td>
                                    <th><?php echo $bp->com_departure_date; ?></th>
                                    <th><?php echo $bp->com_member; ?></th>
