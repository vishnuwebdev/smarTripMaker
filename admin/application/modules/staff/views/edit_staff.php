					...
					<tbody>
						<tr>
							...
							<td><input type="text" name="first_name"
								class="form-control" placeholder="Enter Staff First Name " value="<?php echo $bp_staff_detail->dsast_first_name;?>"></td>
							<td class="warning">Last Name</td>
							<td><input type="text" name="last_name"
								class="form-control" placeholder="enter Staff Last Name " value="<?php echo $bp_staff_detail->dsast_last_name;?>"></td>
						</tr>
						<tr>
							<td class="warning">Email*</td>
							<td><input type="text" name="email" class="form-control"
								placeholder="Email ID" value="<?php echo $bp_staff_detail->dsast_email;?>"></td>
							<td class="warning">Mobile*</td>
							<td><input type="text" name="mobile" class="form-control" placeholder="Mobile Number" value="<?php echo $bp_staff_detail->dsast_mobile;?>"></td>
						</tr>
					...
					<tbody>
						<tr>
							...
							<td><select multiple class="form-control my_select_box_pickup" name="permission[]">
                                                   ...
                                                   $bp_selected_permission=explode(",",$bp_staff_detail->dsast_permission);
                                                   foreach($module as $results){ 
                                                   	if (in_array ( $results->dsasm_module_name, $bp_dsa_permission )) {
                                                   	?> 
										<option value="<?php echo $results->dsasm_module_name;?>" <?php if(in_array($results->dsasm_module_name, $bp_selected_permission)){ echo "selected"; }?>><?php echo $results->dsasm_module_display_name;?></option>
										<?php }}?>
                                                </select></td>
						</tr>
					</tbody>
