					...
					<div class="tile-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="input text">
									<?php
									$selcted_status = set_value('status');?>
									<select class="form-control" name="status">
									<option value="active" <?php if($result->visa_status=="active" || $selcted_status == "active" ){ echo "selected"; } ?>><?php echo $this->lang->line ( "active" );?> </option>
									<option value="inactive" <?php if($result->visa_status=="inactive" || $selcted_status == "inactive" ){ echo "selected"; } ?>><?php echo $this->lang->line ( "inactive" );?> </option>
									</select>
								</div>
							</div>
						</div>
