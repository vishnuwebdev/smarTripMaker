	...
	<div class="page page-forms-validate">
		<div class="pageheader">
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a href="<?php echo site_url($this->uri->segment("1"));?>/font_awesome"></i> <?php echo $this->uri->segment("1");?></a></li>
					<li><a></i>Font Awesome </a></li>
				</ul>
			</div>
		</div>
		<!-- row -->
		...
		<section class="tile">
                                ...
                                <div class="tile-body">
                                    ...
                                    <p class="lead">Font Awesome gives you scalable vector icons that can instantly be customized — size, color, drop shadow, and anything that can be done with the power of CSS.</p>
