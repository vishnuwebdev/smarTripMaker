...
<section id="content">
	<div class="page page-forms-validate">
		<div class="pageheader">
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a></i> <?php echo $this->lang->line ( "add" );?> <?php echo $this->lang->line ( "hotel" );?> <?php echo $this->lang->line ( "amenity" );?></a></li>
				</ul>
			</div>
		</div>
		<!-- row -->
		<div class="row">
			...
			<div class="col-md-12">
				<!-- tile -->
				<a href="<?php echo site_url().$this->uri->segment ( '1' ) ;?>/hotel_amenity" class="btn btn-greensea btn-ef btn-ef-7 btn-ef-7h mb-10 pull-right"><i class="fa fa-list"></i> <?php echo $this->lang->line ( "hotel" );?> <?php echo $this->lang->line ( "amenity" );?></a>
				<div class="clearfix"></div>
				<section class="tile bp_shadow">
					<!-- tile header -->
					<div class="tile-header dvd dvd-btm">
						<h1 class="custom-font">
							<?php echo $this->lang->line ( "add" );?> <strong> <?php echo $this->lang->line ( "hotel" );?> <?php echo $this->lang->line ( "amenity" );?> </strong>
						</h1>
					</div>
					<!-- /tile header -->
					<form class="form-horizontal" role="form" action="" method="post" id="add_hotel_amenity" enctype="multipart/form-data">
						...
						<div class="panel panel-info">
							<div class="panel-heading">
								<div class="panel-title hidden-xs"><?php echo $this->lang->line ( "hotel" );?> <?php echo $this->lang->line ( "amenity" );?> </div>
							</div>
							<div class="panel-body pn">
								...
								<table class="table table-bordered bp_table_td">
									<tbody>
										<tr>
											<td class="warning"><?php echo $this->lang->line ( "hotel" );?> <?php echo $this->lang->line ( "amenity" );?>*</td>
										...
										<tr>
											<td class="warning"><?php echo $this->lang->line ( "enter" );?> <?php echo $this->lang->line ( "icon" );?> <?php echo $this->lang->line ( "code" );?></td>
											<td><input type="text" name="icon" class="form-control" placeholder="Ex- fa-adjust"></td>
											<td class="warning"><?php echo $this->lang->line ( "icon" );?> <?php echo $this->lang->line ( "code" );?></td>
											<td><a target="_blank" href="<?php echo site_url();?>online/font_awesome" class="btn btn-xs btn-info">  <?php echo $this->lang->line ( "icon" );?> <?php echo $this->lang->line ( "code" );?> <?php echo $this->lang->line ( "list" );?></a></td>
										</tr>
										<tr>
