...
<section id="content">
	<div class="page page-forms-validate">
		<div class="pageheader">
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a></i> <?php echo $this->lang->line ( "add_package_category" );?></a></li>
				</ul>
			</div>
		</div>
		<!-- row -->
		<div class="row">
			...
			<div class="col-md-12">
				<!-- tile -->
				<a href="<?php echo site_url();?>holiday/category_list" class="btn btn-greensea btn-ef btn-ef-7 btn-ef-7h mb-10 pull-right"><i class="fa fa-list"></i> <?php echo $this->lang->line ( "category_list" );?></a>
				<div class="clearfix"></div>
				<section class="tile bp_shadow">
					<!-- tile header -->
					<div class="tile-header dvd dvd-btm">
						<h1 class="custom-font">
							 <strong> <?php echo $this->lang->line ( "add_package_category" );?> </strong>
						</h1>
					</div>
					<!-- /tile header -->
								...
								<table class="table table-bordered bp_table_td">
									<tbody>
										<tr>
											...
											<td><input type="text" name="start_price" class="form-control" placeholder="category Start Price"></td>-->
										</tr>
										<tr>
