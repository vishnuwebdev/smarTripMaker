...
<form class="form-horizontal" role="form" action="" method="post" id="">
	...
	<div class="dvd dvd-btm m-10">
		<h1 class="custom-font">
			<strong><?php echo $this->lang->line ( "add_tour_itinerary" );?> </strong>
					...
					<div class="tile-body">
					        <div class="form-group">
								...
								<div class="col-sm-9">
									<div class="input text">
									        ...
									        <option value="<?php echo $i+1;?>"><?php echo $this->lang->line ( "day" );?> <?php echo $i+1;?></option>
									       <?php } ?> 
									        </select>
									</div>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="input text">
									        <input type="text" name="title" value="" placeholder="Itinerary Title" class="form-control">
									</div>
								</div>
							</div>
			...
			<?php
						if (is_array ( $bp_meal )) {
							foreach ( $bp_meal as $bp_meals ) {
								?>
				<label class="checkbox-inline"> <input type="checkbox" name="meal[]" value="<?php echo $bp_meals->holmeal_id;?>"> <i class="fa <?php echo $bp_meals->holmeal_icon;?>"> </i> <?php echo $bp_meals->holmeal_meal_name;?> (<?php echo $bp_meals->holmeal_meal_type;?>, <?php echo $bp_meals->holmeal_meal_description;?>), (<?php echo $bp_meals->holmeal_language;?>)
				</label><br>
				<?php } }?>
			</div>
		</div>
		-->
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="input text">
									        <input type="text" name="remark" value="" placeholder="Remark" class="form-control">
									</div>
								</div>
							</div>
