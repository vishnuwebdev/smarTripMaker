		...
		<div class="pageheader">
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a></i> <?php echo $this->lang->line ( "add_room_amenity" );?></a></li>
				</ul>
			</div>
		</div>
		<!-- row -->
				...
				<section class="tile bp_shadow">
					...
					<div class="tile-header dvd dvd-btm">
						<h1 class="custom-font">
							 <strong> <?php echo $this->lang->line ( "room_amenity_list" );?> </strong>
						</h1>
					</div>
					<!-- /tile header -->
								...
								<table class="table table-bordered bp_table_td">
									<tbody>
										<tr>
											...
											<td><input type="text" name="name" class="form-control" placeholder="Enter Room Amenity"></td>
