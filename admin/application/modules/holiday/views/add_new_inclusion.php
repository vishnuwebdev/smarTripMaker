...
<section id="content">
	<div class="page page-forms-validate bp_page">
		<div class="pageheader bp_pageheader">
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a></i> <?php echo $this->lang->line ( "add_package_inclusion" );?></a></li>
				</ul>
			</div>
		</div>
		<!-- row -->
		<div class="row">
			...
			<div class="col-md-12">
				<!-- tile -->
				<a href="<?php echo site_url();?>holiday/inclusion_list" class="btn btn-greensea btn-ef btn-ef-7 btn-ef-7h mb-10 pull-right"><i class="fa fa-list"></i> <?php echo $this->lang->line ( "inclusion_list" );?></a>
						...
						<div class="panel panel-info">
							<div class="panel-heading">
								<div class="panel-title hidden-xs">
									 <strong> <?php echo $this->lang->line ( "add_package_inclusion" );?> </strong>
								</div>
							</div>
							<div class="panel-body pn">
								...
								<table class="table table-bordered bp_table_td">
									<tbody>
										<tr>
											<td class="warning"><?php echo $this->lang->line ( "inclusion_name" );?>*</td>
											<td><input type="text" name="name" class="form-control" placeholder="Enter Inclusion Name" required></td>
