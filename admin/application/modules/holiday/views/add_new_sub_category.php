		...
		<div class="pageheader">
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a></i> <?php echo $this->lang->line ( "add_package_sub_category" );?></a></li>
				</ul>
			</div>
		</div>
		<!-- row -->
				...
				<section class="tile bp_shadow">
					...
					<div class="tile-header dvd dvd-btm">
						<h1 class="custom-font">
							<strong> <?php echo $this->lang->line ( "add_package_sub_category" );?> </strong>
						</h1>
					</div>
					<!-- /tile header -->
									...
									<tbody>
										...
										<tr>										
									        ...
									        if($bp->holcat_status == "active"){
									        	?>
									      <option value="<?php echo $bp->holcat_id;?>"><?php echo $bp->holcat_name;?> </option>
									       <?php } } }?>
											</select></td>
