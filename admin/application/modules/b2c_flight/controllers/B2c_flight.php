<?php
class B2c_flight extends MX_Controller {
	function __construct() {
		parent::__construct ();
		$this->load->Model ( 'B2c_flight_Model' );
		$this->model_name = "B2c_flight_Model";
	...
	public function booking_list(){
		...
		$table = "flight_booking_list";
		$where_1_name = "fbook_module";
		$where_1_value = "B2C";
		$where_2_name = "fbook_user_id";
		$where_2_value = $bp_user_id;
		$order_by = "fbook_id";
		$bp_template_name = "flight_booking_list";
