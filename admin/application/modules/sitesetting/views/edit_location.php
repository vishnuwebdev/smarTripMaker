		...
		<div class="pageheader">
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a></i> <?php echo $this->lang->line ( "edit_location" );?></a></li>
				</ul>
			</div>
		</div>
		<!-- row -->
				...
				<section class="tile bp_shadow">
					...
					<div class="tile-header dvd dvd-btm">
						<h1 class="custom-font">
							<strong><?php echo $this->lang->line ( "edit_location" );?> </strong>
						</h1>
					</div>
					<!-- /tile header -->
					<!-- tile body -->
					<div class="tile-body">
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="input text">
									        <input type="text" name="location" value="<?php echo $location->location_location;?>" placeholder="" class="form-control">
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="input text">
									      ...
									      <option value="<?php echo $bp->country_code."___".$bp->country_name;?>" <?php if($location->location_country_code==$bp->country_code){ echo "selected"; }?>><?php echo $bp->country_name;?></option>
									       <?php }?>
									        </select>
									</div>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="input text">
									        <input type="text" name="latitude" value="<?php echo $location->location_latitude;?>" placeholder="" class="form-control">
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="input text">
									        <input type="text" name="longitude" value="<?php echo $location->location_longitude;?>" placeholder="" class="form-control">
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="input text">
										...
										<option value="<?php echo $all_languages;?>" <?php if($location->location_language==$all_languages){ echo "selected"; }?>><?php echo $all_languages;?></option>
										<?php }?>
										</select>
									</div>
								</div>
