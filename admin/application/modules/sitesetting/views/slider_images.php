...
<section id="content">
    <div class="page page-forms-validate">
        <div class="pageheader">
            <div class="page-bar">
                <ul class="page-breadcrumb">
					...
					<li>
					<a href="<?php echo site_url(); ?>/sitesetting">
                            <?php echo $this->lang->line("setting"); ?></a>
					</li>
                    <li>
					<a href="#">
                            <?php echo $this->lang->line("slider_image"); ?></a>
					</li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            <!-- col -->
            <div class="col-md-12">
                <a href="<?php echo site_url() ?>sitesetting/add_slider_image" class="btn btn-greensea btn-ef btn-ef-7 btn-ef-7h mb-10 pull-right"><i class="fa fa-list"></i> <?php echo $this->lang->line("add_new_image"); ?></a>
                <div class="clearfix" ></div>
                <section class="tile bp_shadow">
                    <!-- tile header -->
                    <div class="tile-header dvd dvd-btm">
                        <h1 class="custom-font">
                            <strong><?php echo $this->lang->line("slider_image"); ?> </strong> <?php echo $this->lang->line("list"); ?>
                        </h1>
                    </div>
                    <?php
                                        ...
                                        foreach ($bp_iamges as $bp) {
                                            ...
                                            <tr>
                                                ...
                                                <td><div class="pull-left thumb" style="width: 80px;">
                                                        <?php if ($bp->sliimg_image != "") { ?>
                                                            <img class="media-object thumbscl" src="<?php echo site_url(); ?>assets/img/slider/thumbs/<?php echo $bp->sliimg_image; ?>" alt="<?php echo $bp->sliimg_alt; ?>">
                                                        <?php } else { ?>
                                                            <img class="media-object thumbscl" src="<?php echo site_url(); ?>assets/images/not_found.png" alt="<?php echo $bp->sliimg_alt; ?>">
                                                        <?php } ?>
                                                    </div></td>
                                                <td><?php echo $bp->sliimg_title; ?></td>
                                                <td><?php echo $bp->sliimg_alt; ?></td>
                                                <td><?php echo $bp->sliimg_detail; ?></td>
                                                <td><?php if ($bp->sliimg_status == "active") { ?><a href="<?php echo site_url(); ?>sitesetting/update_slider_img_status?ref_id=<?php echo url_encode($bp->sliimg_id); ?>&status=inactive" class="label label-success"><?php echo $this->lang->line($bp->sliimg_status); ?></a><?php } else { ?><a
                                                            href="<?php echo site_url(); ?>sitesetting/update_slider_img_status?ref_id=<?php echo url_encode($bp->sliimg_id); ?>&status=active" class="label label-danger"><?php echo $this->lang->line($bp->sliimg_status); ?></a><?php } ?></td>
                                                <td><?php echo date_format(date_create($bp->sliimg_update_date), "h:i A , d M Y"); ?></td>
                                                <td><a href="<?php echo site_url(); ?>sitesetting/edit_slider_image?image_id=<?php echo url_encode($bp->sliimg_id); ?>" class="btn btn-primary btn-rounded btn-ef btn-xs btn-ef-5 btn-ef-5b"><i class="fa fa-pencil"></i> <span>Edit</span></a>
                                                    <button class="btn btn-danger btn-rounded btn-ef btn-ef-5 btn-ef-5b btn-xs" onclick="confirm_pop_up('<?php echo site_url(); ?>sitesetting/delete_slider_image/?sliimg_id=<?php echo url_encode($bp->sliimg_id); ?>')">
