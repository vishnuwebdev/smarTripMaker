...
<form class="form-horizontal" role="form" action="" method="post" id="" enctype="multipart/form-data">
        ...
        <div class="pageheader">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li><a href="<?php echo site_url($this->uri->segment("1")); ?>"></i>Edit Offer Image</a></li>
                </ul>
            </div>
        </div>
          <div class="row">
	...
	<div class="tile-header dvd dvd-btm">
		<h1 class="custom-font">
			<strong>Edit Offer Image </strong>
	...
	<section class="tile bp_shadow">
					<div class="tile-body">
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="input text">
									        ...
									        <input type="hidden" name="image" value="<?php echo $bp_image[0]->hos_image;?>">
									        <div class="pull-left thumb" style="width: 80px;">
                                            <?php if($bp_image[0]->hos_image!=""){?>
                                                            <img class="media-object thumbscl" src="<?php echo site_url();?>assets/img/offer/thumbs/<?php echo $bp_image[0]->hos_image; ?>" alt="">
                                                       <?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="input text">
									        <input type="text" name="title" value="<?php echo $bp_image[0]->hos_title?>" placeholder="Image Title" class="form-control">
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="input text">
									        <input type="text" name="url" value="<?php echo $bp_image[0]->hos_url?>" placeholder="Image Url" class="form-control">
									</div>
								</div>
							</div>
