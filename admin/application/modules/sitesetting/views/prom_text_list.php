...
<section id="content">
    <div class="page page-forms-validate">
        ...
        <div class="row">
            <!-- col -->
            <div class="col-md-12">
                <a href="<?php echo site_url() ?>sitesetting/add_prom_text" class="btn btn-greensea btn-ef btn-ef-7 btn-ef-7h mb-10 pull-right"><i class="fa fa-list"></i> <?php echo  "Add Promotion Text"; ?></a>
                <div class="clearfix" ></div>
                <section class="tile bp_shadow">
                    <!-- tile header -->
                    <div class="tile-header dvd dvd-btm">
                        <h1 class="custom-font">
                            <strong><?php echo "Promotion Text"; ?> </strong> <?php echo $this->lang->line("list"); ?>
                        </h1>
                    </div>
                    <?php
                                    ...
                                    if (is_array($bp_iamges)) {
                                        ...
                                        foreach ($bp_iamges as $bp) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $bp->promtxt_title; ?></td>
                                             
                                                <td><?php echo $bp->promtxt_detail; ?></td>
                                                <td><?php if ($bp->promtxt_status == "active") { ?><a href="<?php echo site_url(); ?>sitesetting/update_prom_text_status?ref_id=<?php echo url_encode($bp->promtxt_id); ?>&status=inactive" class="label label-success"><?php echo$bp->promtxt_status; ?></a><?php } else { ?><a
                                                            href="<?php echo site_url(); ?>sitesetting/update_prom_text_status?ref_id=<?php echo url_encode($bp->promtxt_id); ?>&status=active" class="label label-danger"><?php echo $bp->promtxt_status; ?></a><?php } ?></td>
                                                <td><?php echo $bp->promtxt_align ; ?></td>
                                                <td><?php echo date_format(date_create($bp->promtxt_update_date), "h:i A , d M Y"); ?></td>
                                                <td><a href="<?php echo site_url(); ?>sitesetting/edit_prom_text?text_id=<?php echo url_encode($bp->promtxt_id); ?>" class="btn btn-primary btn-rounded btn-ef btn-xs btn-ef-5 btn-ef-5b"><i class="fa fa-pencil"></i> <span>Edit</span></a>
                                                    <button class="btn btn-danger btn-rounded btn-ef btn-ef-5 btn-ef-5b btn-xs" onclick="confirm_pop_up('<?php echo site_url(); ?>sitesetting/delete_prom_text/?prom_id=<?php echo url_encode($bp->promtxt_id); ?>')">
