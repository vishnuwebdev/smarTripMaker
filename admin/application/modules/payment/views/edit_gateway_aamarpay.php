		...
		<div class="pageheader">
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a href="<?php echo site_url($this->uri->segment("1"));?>"></i><?php echo $this->lang->line ( "getway" );?></a></li>
				...
				<section class="tile bp_shadow">
					...
					<div class="alert alert-big alert-lightred alert-dismissable fade in">
							...
							<div class="aamarpay" >
								...
								<div class="col-sm-9">
									<div class="input text">
										<input type="text" name="g_salt" placeholder="" class="form-control" value="<?php echo $result->dsapayg_gateway_salt_key; ?>">
									</div>
								</div>
							</div>
                        	</div>
