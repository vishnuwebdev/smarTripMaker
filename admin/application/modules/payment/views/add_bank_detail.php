		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<section class="tile bp_shadow">
					...
					<?php echo form_open_multipart('payment/add_bank_detail',$attributes); ?>
					<!-- tile body -->
					<div class="tile-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="input text">
											...
											placeholder="" class="form-control" value="<?php echo set_value('bank_name'); ?>">
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="input text">
										<input type="text" name="bank_account_name"
											placeholder="" class="form-control" value="<?php echo set_value('bank_account_name'); ?>">
									</div>
								</div>
							</div>
								...
								<div class="col-sm-9">
									<div class="input text">
										<input type="text" name="bank_account_number"
											placeholder="" class="form-control" value="<?php echo set_value('bank_account_number'); ?>">
									</div>
								</div>
							</div>
                                             <div class="form-group">
								...
								<div class="col-sm-9">
									<div class="input text">
										<input type="text" name="bank_branch_name"
											placeholder="" class="form-control" value="<?php echo set_value('bank_branch_name'); ?>">
									</div>
								</div>
							</div>
								...
								<div class="col-sm-9">
									<div class="input text">
										<input type="text" name="bank_ifsc_code"
											placeholder="" class="form-control" value="<?php echo set_value('bank_ifsc_code'); ?>">
									</div>
								</div>
							</div>
								...
								<div class="col-sm-9">
									<div class="input text">
										<input type="text" name="bank_swift_code"
											placeholder="" class="form-control" value="<?php echo set_value('bank_swift_code'); ?>">
									</div>
								</div>
							</div>
