...
$IB_bp_sms_ticket_one['DepTime'] = $OB_ticket->Segments[1]->Origin->DepTime;
...
$IB_bp_sms_ticket_oneway_string = "Dear " . $bp_sms_ticket_one['FirstName'] . ", Your booking detail is PNR  " . $bp_sms_ticket_one['PNR'] . ", " . $bp_sms_ticket_one['Destination'] . "-" . $bp_sms_ticket_one['Origin'] . ", Flight " . $bp_sms_ticket_one['AirlineName'] . " " . $bp_sms_ticket_one['AirlineCode'] . "-" . $bp_sms_ticket_one['FlightNumber'] . " (" . date_format(date_create($BookingDetails->fbook_return_date), "d M Y") . "),Lead Pax - " . $bp_sms_ticket_one['Title'] . ". " . $bp_sms_ticket_one['FirstName'] . " " . $bp_sms_ticket_one['LastName'] . "." . PHP_EOL . " " . PHP_EOL . " " . $this->user_data->dsa_company_name . "";
?>
<html >
    <head>
        <meta charset="UTF-8">
                                                ...
                                                <thead style="background-color: #d8d8d8;">
                                                    <tr>
                                                        <td colspan="3" style=" text-align:center; border-radius:4px; vertical-align:middle;padding: 7px 12px;">
                                                            <p style="font-size:14px; text-transform:uppercase; color:#333333; margin:0;">
                                                                <strong>Payment Details (OutBond + Inbond)</strong></p>
                                                        </td>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right" style="vertical-align:middle; padding:22px 50px 22px 0; ">
                                                            <p style="color:#FFF; font-size:18px; margin:0; ">
                                                                <a href="<?php echo base_url(); ?>" target="_blank" style="text-decoration:none; color:#171616; font-weight:bold;outline:0;"><?php echo base_url(); ?></a>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
