...
<section id="content">
	<div class="page page-forms-validate">
		<div class="pageheader">
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li><a></i>B2C Hotel Discount List </a></li>
				</ul>
			</div>
		</div>
		<!-- row -->
		<div class="row">
			...
			<div class="col-md-12">
				<!-- tile -->
				<a href="<?php echo site_url().$this->uri->segment ( '1' );?>/add_hotel_discount" class="btn btn-greensea btn-ef btn-ef-7 btn-ef-7h mb-10 pull-right"><i class="fa fa-plus"></i> Add B2C Discount</a>
				<div class="clearfix"></div>
				<section class="tile bp_shadow">
					<!-- tile header -->
					<div class="tile-header dvd dvd-btm">
						<h1 class="custom-font">
							<strong>B2C Hotel Discount List</strong>
						</h1>
					</div>
					<?php
						...
						<table class="table table-bordered bp_table">
							...
							<tbody>
								...
								?>
                                        <tr>
                                            <td><?php echo $i;?> </td>
                                             <td><?php echo $bp->hdis_fix; ?></td>
                                             <!-- <td><?php echo $bp->hdis_class; ?></td> -->
                                          	 <td><?php echo date_format(date_create($bp->hdis_update_date),"h:i A , d M Y");?></td>
                                            <td>
                                                <button class="btn btn-danger btn-rounded btn-ef btn-ef-5 btn-ef-5b btn-xs"  onclick="addidfordelete('<?php echo site_url().$this->uri->segment ( "1" );?>/delete_b2c_discount/?ref_id=<?php echo url_encode($bp->hdis_id); ?>')"><i class="fa fa-trash"></i> <span><?php echo $this->lang->line ( "delete" );?></span></button>  
                                                </td>
                                        </tr>
                                       <?php 
									$i++;
